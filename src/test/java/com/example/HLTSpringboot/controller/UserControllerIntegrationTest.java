...
public class UserControllerIntegrationTest {
    ...
    static void configDatasoure(DynamicPropertyRegistry registry) {
    ...
    void createUser_validRequest_success() throws Exception {
        ...
        var response = mockMvc.perform(MockMvcRequestBuilders.post("/users")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("result.username").value("Rayen"))
                .andExpect(MockMvcResultMatchers.jsonPath("result.firstName").value("rayen"))
                .andExpect(MockMvcResultMatchers.jsonPath("result.lastName").value("iso"));
